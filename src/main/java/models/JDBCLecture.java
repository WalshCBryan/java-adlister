...
//            statement.execute(); --any CRUD operation(combo of latter 2)
//            statement.executeUpdate();  --Create, Update, or Delete
//            statement.executeQuery();  --Read(Selects)

//            ResultSet rs = statement.executeQuery(query);
//
//            think of rs.next() as moving the cursor down one line
//            rs.next();
//
//            looks at individual columns, over one column
